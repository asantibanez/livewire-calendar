...
<div
    ...
    style="min-width: 10rem; max-height:9rem;">
    ...
    <div
        ...
        <div
            ...
            @endif
            class="w-full h-full p-2 {{ $dayInMonth ? $isToday ? 'bg-indigo-200' : ' bg-white ' : 'bg-gray-100' }} flex flex-col border border-gray-600">
